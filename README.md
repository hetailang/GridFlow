...
14. **自适应图片大小** - 点击"图片裁剪"区域的"自适应图片大小"按钮，容器高度自动调整为与图片原始比例一致，同时重置缩放和偏移
15. **导出结果** - 在精细调整面板点击导出或复制，输出 2400px 宽高清 PNG
...
<details>
<summary><strong>2026-03-14</strong> — Phase 2 新增自适应图片大小</summary>
